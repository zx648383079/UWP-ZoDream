//---------------------------------------------------------------------------
//
// <copyright file="BandNewsDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class BandNewsDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public BandNewsDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new BandNewsSection());
